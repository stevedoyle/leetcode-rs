...
impl Solution {
    pub fn roman_to_int(s: String) -> i32 {
        ...
        for c in s.chars() {
            ...
            // For the subtraction cases (IV, IX, XL, XC, CD, CM), we subtract twice the previous
            // value because we added it once before.
            // Example: IV = 5 - 2 * 1 = 3
            result += if prev < curr { curr - 2 * prev } else { curr };
            prev = curr;
        }
        result
    }
